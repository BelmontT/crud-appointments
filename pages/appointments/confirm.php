...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query = "UPDATE appointments SET appointments_status = 'Confirmado' WHERE appointments_id = $appointmentId";
    if (mysqli_query($conn, $query)) {
        $message = "Agendamento confirmado com sucesso!";
        $messageClass = "boxSuccess";
        header("Location: ../account.php");
    } else {
        $message = "Erro ao confirmar o agendamento: " . mysqli_error($conn);
