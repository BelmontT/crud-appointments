...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query = "UPDATE appointments SET appointments_status = 'Cancelado' WHERE appointments_id = $appointmentId";
    if (mysqli_query($conn, $query)) {
        $message = "Agendamento cancelado com sucesso!";
        $messageClass = "boxSuccess";
        header("Location: ../account.php");
    } else {
        $message = "Erro ao cancelar o agendamento: " . mysqli_error($conn);
